...
public class SQLiteDataController extends SQLiteOpenHelper {
    ...
    public boolean insertLopHoc(Maintopic maintopic) {
        boolean result = false;
        try {

            openDataBase();
            ContentValues values = new ContentValues();
            values.put("Maintopic_Tittle", maintopic.getMaintopic_Tittle());
            values.put("Maintopic_Tittle_VN", maintopic.getMaintopic_Tittle_VN());
            values.put("Maintopic_Process", maintopic.getMaintopic_Process());
